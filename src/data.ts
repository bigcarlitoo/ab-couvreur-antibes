...
export const defaultRealisations: Realisation[] = [
  {
    id: "chantier-zinc-joint-debout",
    title: "Couverture zinc à joint debout",
    city: "Antibes",
    description:
      "Pose d'une couverture zinc à joint debout sur villa antiboise. Profilés alignés, abergements et solins façonnés sur mesure pour une étanchéité parfaite.",
    roofType: "Zinc joint debout",
    image: "/assets/ab-source/ab-09.webp",
    duration: "5 jours",
    serviceId: "zinguerie",
  },
  {
    id: "chantier-zinguerie-detail",
    title: "Reprise de zinguerie & points singuliers",
    city: "Cannes",
    description:
      "Traitement complet des raccords métalliques, sécurisation des solins de cheminée et contrôle des ruissellements sur une villa cannoise.",
    roofType: "Zinc & raccords",
    image: "/assets/ab-source/ab-10.webp",
    duration: "2 jours",
    serviceId: "zinguerie",
  },
  {
    id: "chantier-charpente-liteaux",
    title: "Reprise de charpente & écran sous-toiture",
    city: "Juan-les-Pins",
    description:
      "Mise à nu de la charpente, pose d'un nouvel écran sous-toiture, reprise des liteaux et approvisionnement des tuiles terre cuite prêtes à être posées.",
    roofType: "Charpente + tuiles",
    image: "/assets/ab-source/ab-11.webp",
    duration: "6 jours",
    serviceId: "charpente",
  },
  {
    id: "chantier-tuiles-canal",
    title: "Pose de tuiles canal sur villa",
    city: "Cap d'Antibes",
    description:
      "Pose soignée de tuiles canal avec calepinage régulier, faîtage scellé et rives sécurisées. Toiture prête à affronter les coups de mistral et les pluies méditerranéennes.",
    roofType: "Tuiles canal",
    image: "/assets/ab-source/ab-12.webp",
    duration: "5 jours",
    serviceId: "tuiles-mecaniques",
  },
  {
    id: "chantier-couverture-complete",
    title: "Réfection complète de couverture",
    city: "Antibes",
    description:
      "Réfection complète d'une toiture résidentielle à Antibes : dépose totale, traitement du support, pose neuve et finitions soignées. Garantie décennale incluse.",
    roofType: "Couverture tuiles",
    image: "/assets/ab-source/ab-13.webp",
    duration: "8 jours",
    serviceId: "toiture",
  },
  {
    id: "chantier-facade-diagnostic",
    title: "Diagnostic façade avant ravalement",
    city: "Biot",
    description:
      "Analyse complète d'une façade avant ravalement : repérage des cloquages, traces de ruissellement et porosité du support pour préparer le bon traitement.",
    roofType: "Façade & toiture",
    image: "/assets/ab-source/ab-14.webp",
    duration: "Diagnostic",
    serviceId: "ravalement-facade",
  },
  {
    id: "chantier-hydrofuge",
    title: "Nettoyage & hydrofuge coloré",
    city: "Mougins",
    description:
      "Démoussage complet, brossage manuel sur tuiles fragiles, traitement anti-mousse puis application d'un hydrofuge coloré pour redonner toute son intensité à la toiture.",
    roofType: "Tuiles canal anciennes",
    image: "/assets/ab-source/ab-15.webp",
    duration: "2 jours",
    serviceId: "hydrofuge-toiture",
  },
  {
    id: "chantier-nettoyage-toiture",
    title: "Démoussage de toiture",
    city: "Vallauris",
    description:
      "Nettoyage à pression contrôlée d'une toiture envahie de mousses et lichens. Brossage manuel des zones fragiles puis traitement préventif anti-mousse.",
    roofType: "Tuiles mécaniques",
    image: "/assets/ab-source/ab-16.webp",
    duration: "2 jours",
    serviceId: "nettoyage-toiture",
  },
  {
    id: "chantier-charpente-vue",
    title: "Inspection de charpente traditionnelle",
    city: "Valbonne",
    description:
      "Inspection complète d'une charpente traditionnelle bois sur villa de Valbonne. Contrôle structurel, traces d'humidité et plan de renforcement ciblé.",
    roofType: "Charpente bois",
    image: "/assets/ab-source/ab-17.webp",
    duration: "Diagnostic",
    serviceId: "charpente",
  },
  {
    id: "chantier-isolation-combles",
    title: "Isolation de combles aménagés",
    city: "Nice",
    description:
      "Pose d'un isolant performant en combles aménagés : confort thermique amélioré l'hiver et fraîcheur préservée pendant les journées d'été azuréennes.",
    roofType: "Isolation combles",
    image: "/assets/ab-source/ab-18.webp",
    duration: "3 jours",
    serviceId: "isolation-toiture",
  },
  {
    id: "chantier-velux-pose",
    title: "Pose de Velux & étanchéité",
    city: "Juan-les-Pins",
    description:
      "Ouverture en toiture, pose d'un Velux, raccords d'étanchéité et habillage intérieur. La lumière naturelle transforme les combles en pièce à vivre.",
    roofType: "Velux + tuiles",
    image: "/assets/ab-source/ab-19.webp",
    duration: "2 jours",
    serviceId: "velux",
  },
  {
    id: "chantier-couverture-extension",
    title: "Couverture neuve sur extension",
    city: "Mougins",
    description:
      "Création d'une couverture neuve sur une extension de villa : structure soignée, faîtage scellé, rives parfaitement alignées et finition haut de gamme.",
    roofType: "Tuiles mécaniques",
